  ...
  return (
    <View style={styles.shipContainer}>
      ...
      <Text style={styles.shipContent}>
        {props.data.address}, Desa {props.data.village}, Kecamatan{' '}
        {props.data.district}, {props.data.city}, Provinsi {props.data.province}{' '}
    ...
    <View style={styles.shipContainer}>
      ...
      <View style={{marginTop: 8, marginStart: 8}}>
        <TextInput
          mode="outlined"
          label="Bank Anda"
          onChangeText={value => updateBank(value)}
        />
        <TextInput
          mode="outlined"
        ...
        <TextInput
          mode="outlined"
          label="Rekening"
          onChangeText={value => updateAccount(value)}
        />
      </View>
    </View>
  );

    ...
    <View style={{ backgroundColor: "#e87c80" }}>
      ...
      <View style={styles.container}>
        <Input
          ...
          }} onChangeText={(value) => setOldPassword(value)} secureTextEntry={true} value={oldPassword}
        />
      </View>
      <View style={styles.container}>
        <Input
          ...
          inputContainerStyle={{
            borderBottomColor: "#dedede",
          }} onChangeText={(value) => setNewPassword(value)} secureTextEntry={true} value={newPassword}
        />
      </View>
      <View style={styles.container}>
        <Input
          ...
          inputContainerStyle={{
            borderBottomColor: "#dedede",
          }} onChangeText={(value) => setVerifyPassword(value)} secureTextEntry={true} value={verifyPassword}
        />
      </View>
